...
// let list: Array<any> = [true ,14, "sam"];
// console.log(list);
...
// console.log(p, validPerson, invalidPerson);
...
// console.log(name, greeting, multiline);
...
// let order3: Order = "A small Espreeso";
// console.log(order1);
// console.log(order2);
// console.log(order3);
